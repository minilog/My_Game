...
public:
	...
	static KetQuaVaCham kqvcHCNVaHCN(RECT in_HCN1, RECT in_HCN2);
	static PhiaVaCham pvcPhiaVaCham(ThucThe *in_ThucThe1, KetQuaVaCham in_KetQuaVaCham);
	// nếu Rectangle quá to thì va chạm có thể bị sai
	static PhiaVaCham pvcPhiaVaCham(ThucThe *in_ThucThe1, ThucThe *in_ThucThe2);
};
