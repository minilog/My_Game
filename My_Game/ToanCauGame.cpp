...
bool ToanCauGame::mLaGameDangChay = true;
...
HINSTANCE ToanCauGame::NhanTruongHopXuLy()
{
...
HWND ToanCauGame::NhanCuaSoXuLy()
{
	return mCuaSoXuLy;
}
...
LPD3DXSPRITE ToanCauGame::NhanXuLyHinhAnh()
{
	return mXuLyHinhAnh;
}
...
LPDIRECT3DDEVICE9 ToanCauGame::NhanThietBi()
{
	return mThietBi;
}
